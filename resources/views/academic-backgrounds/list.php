...
<main class="l-main">
    <div class="l-main__head">
        <hgroup class="c-title">
            <h1>学歴一覧</h1>
            <p>ACADEMIC BACKGROUND LIST</p>
        </hgroup>
        <div class="c-btn c-btn--create">
            <a href="<?= route('academic-backgrounds-register.show'); ?>">新規作成</a>
        </div>
    </div>
    <div class="l-main__body">
                ...
                <div class="c-card__content js-handleSlide">
                    ...
                    <div class="c-card__foot">
                        <div class="c-card__btn">
                            <a href="<?= route('academic-backgrounds-edit.show', ['id' => sanitize($value['id'])]); ?>">
        ...
        <div class="p-noResult">
            <div class="p-noResult__inner">
                <p class="c-text--m c-text--center">学歴の登録がありません。</p>
                <p class="c-text--m c-text--center">新規作成ボタンから学歴を登録してください。</p>
            </div>
        </div>
        <?php endif; ?>
    </div>
	<?php view_parts('apiDeleteModal', ["target" => 'academic-background']); ?>
</main>
